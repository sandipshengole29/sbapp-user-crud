...
public class ApiError {
	 ...
	 */
	public void addValidationError(ConstraintViolationException cv) {
		this.addValidationError(cv.getClass().getName(),
				cv.getConstraintName(), cv.getSQL(), cv.getMessage());
	}

	public void addValidationErrors(Set<ConstraintViolationException> constraintViolations) {
